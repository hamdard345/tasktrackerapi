 ...
 */
class DeleteTask extends Endpoint{
    ...
    {
        $sql = "UPDATE tasks SET deleted = :deleted, deletedAt = :deletedAt WHERE id = :id
               ";
        $this->setSQL($sql);
        $this->setSQLParams(['id'=> $_POST['id'],'deleted'=> $_POST['deleted'],'deletedAt'=> $_POST['deletedAt']]);
    }
}